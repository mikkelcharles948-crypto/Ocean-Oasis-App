...
export const EVENTS = [
  ...
  { id: 'e_9', title: 'Comess', category: 'Festival', date: '2026-06-27', time: '10:00 PM – 4:00 AM', location: 'La Plas Dame Park, Colihaut', description: 'A colourful bouyon night featuring paint, water, and powder.', icon: 'music', capacity: null, status: 'PUBLISHED', imageUrl: 'https://discoverdominica.com/wp-content/uploads/2026/06/Comess.jpg' },
  { id: 'e_10', title: 'Wellness Fair 2026: Be Well in Nature', category: 'Festival', date: '2026-07-04', time: '9:00 AM – 4:00 PM', location: 'UWI Global Campus Dominica', description: 'Free island-wide celebration of natural health and holistic living.', icon: 'yoga', capacity: null, status: 'PUBLISHED', imageUrl: 'https://discoverdominica.com/wp-content/uploads/2026/06/Health-And-Wellness-2026-Main-Flyer-alt-Massage-Version-1.jpg' },
  { id: 'e_11', title: 'Gouté Domnik', category: 'Festival', date: '2026-07-19', time: 'All week', location: 'Island-wide', description: 'A week-long taste of Dominica — restaurant week, a One Pot Competition, and Farmers\' Marketplace, through July 26.', icon: 'cooking', capacity: null, status: 'PUBLISHED', imageUrl: 'https://discoverdominica.com/wp-content/uploads/2026/07/Goute-Domniik4_5-Medium.jpeg' },
  { id: 'e_12', title: 'Bike Fest 2026', category: 'Festival', date: '2026-07-31', time: 'All weekend', location: 'Island-wide', description: 'Four days of drag racing, exhibitions, and an island-wide ride-out, through August 3.', icon: 'adventure', capacity: null, status: 'PUBLISHED', imageUrl: 'https://discoverdominica.com/wp-content/uploads/2026/06/Dominica-Bike-Fest-2026.jpg' },
  { id: 'e_13', title: 'Dive Fest', category: 'Festival', date: '2026-08-29', time: 'All weekend', location: 'Island-wide dive sites', description: 'Dominica\'s longest-running celebration of the deep — volcanic reef diving and marine reserve exploration.', icon: 'wave', capacity: null, status: 'PUBLISHED', imageUrl: 'https://discoverdominica.com/wp-content/uploads/2026/06/Dive-Fest.jpeg' },
  { id: 'e_14', title: 'Flavours of the World Festival', category: 'Festival', date: '2026-10-04', time: 'All day', location: 'Roseau', description: 'A celebration of island cultures through international cuisine, language, and global rhythms.', icon: 'culture', capacity: null, status: 'PUBLISHED', imageUrl: 'https://content.wicnews.com/production/media/21374/01KX0NA23F1DF8QR3Z12QBW358.jpg' },
  ...
  { id: 'e_16', title: 'WATO Riverfront Food and Culture Festival', category: 'Festival', date: '2026-10-31', time: 'All day', location: 'Roseau riverfront', description: 'Themed "Ancestors" this year — open-fire cooking by Caribbean chefs.', icon: 'cooking', capacity: null, status: 'PUBLISHED', imageUrl: 'https://discoverdominica.com/wp-content/uploads/2026/06/WATO-2026.jpeg' },
  { id: 'e_17', title: 'Dominica Carnival — Mas Domnik', category: 'Festival', date: '2027-01-09', time: 'All month', location: 'Island-wide', description: '"The Real Mas" — bouyon, calypso, and costumes, running through February 10, 2027.', icon: 'culture', capacity: null, status: 'PUBLISHED', imageUrl: 'https://discoverdominica.com/wp-content/uploads/2026/06/Dominica-Carnival-2027.jpg' },
];
